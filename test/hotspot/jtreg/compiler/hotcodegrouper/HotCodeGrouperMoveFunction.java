 ...
 * @run main/othervm -Xbootclasspath/a:. -Xbatch -XX:-TieredCompilation -XX:+UnlockExperimentalVMOptions -XX:+HotCodeHeap -XX:HotCodeHeapSize=2m
 *                   -XX:+NMethodRelocation -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI -XX:HotCodeIntervalSeconds=0
 *                   -XX:HotCodeSampleSeconds=5 -XX:HotCodeSteadyThreshold=1 -XX:HotCodeSampleRatio=1 -XX:HotCodeStartupDelaySeconds=0 -Xlog:hotcodegrouper=trace
